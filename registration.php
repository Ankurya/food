         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="" alt="">Food Ordering Managment System </a>
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="admin/images/register.png" alt="" class="img-fluid">
                        <p></p>
                      
                       
                        <h4 class="m-t-20">ContactUs</h4>
                        <p> If you need any help then you can contact us  </p>
                        <p> <a href="contactus.php" class="btn theme-btn m-t-15">contact us</a> </p>
                     </div>
                     <!-- /WHY? -->
                  </div>
               </div>
               ...
               <div class="container">
                  ...
                  <div class="row top-footer">
                     <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/logo.jpg" alt=""> </a> <span></span> 
                     </div>
